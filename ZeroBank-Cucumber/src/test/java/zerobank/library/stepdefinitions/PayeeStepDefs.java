...
import zerobank.library.utilities.FileUtility;
...
public class PayeeStepDefs {
    ...
    public void creates_new_payee_using_following_information(Map<String, String> table) {
        ...
        payBillsPage.newPayeeAddInput.sendKeys(table.get("Payee Address"));
        payBillsPage.newPayeeAccInput.sendKeys(table.get("Account"));
